public class RedBlackTree {
    ...
    // nil node which acts as a sentinel node for the leaves or the parent of the root node
    ...
    private void rebalance(Node x) {
        while (x.parent.color == Constants.RED) {
            Node otherChild;
            if (x.parent == x.parent.parent.left) {
                otherChild = x.parent.parent.right;
                ...
                if (otherChild != nil && otherChild.color == Constants.RED) {
                    ...
                    x.parent.parent.color = Constants.RED;
                    x = x.parent.parent;
                    continue;
                }
                ...
                otherChild = x.parent.parent.left;
                if (otherChild != nil && otherChild.color == Constants.RED) {
                    x.parent.color = Constants.BLACK;
                    otherChild.color = Constants.BLACK;
                    x.parent.parent.color = Constants.RED;
    ...
    private void rightRotate(Node n) {
        if (n.parent != nil) {
            ...
            // when the node being rotated is the root
            Node left = root.left;
    ...
    private boolean delete(Node nodeToBeDeleted) {
        ...
        if (nodeToBeDeleted.left == nil) {
            ...
            transplantNode(nodeToBeDeleted, nodeToBeDeleted.right);
        } else if (nodeToBeDeleted.right == nil) {
            x = nodeToBeDeleted.left;
            transplantNode(nodeToBeDeleted, nodeToBeDeleted.left);
        } else {
    ...
    private void deleteRebalance(Node x) {
    ...
    private Node search(Node nodeToSearch) {
        if (root == nil)
            return null;
        Node dummyNode = root;
        while (dummyNode != nil) {
    ...
    // inner class to create a red-black tree node
    public class Node {
